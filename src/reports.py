...
def spending_by_category(transactions: pd.DataFrame,
    ...
    category_mask = transactions_copy['Категория'].astype(str).str.contains(
    ...
    monthly_spending = filtered_transactions.groupby('Месяц').agg({
        'Сумма платежа': 'sum',
        'Дата операции': 'count'}).rename(columns={
        'Сумма платежа': 'Сумма трат',
        'Дата операции': 'Количество операций'
    })
...
print(spending_by_category(df, "Супермаркеты", "2021-12-12 12:12:12"))
